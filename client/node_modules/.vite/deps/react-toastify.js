...
var u = (t) => "number" == typeof t && !isNaN(t), d = (t) => "string" == typeof t, p = (t) => "function" == typeof t, m = (t) => d(t) || p(t) ? t : null, f = (t) => (0, import_react.isValidElement)(t) || d(t) || p(t) || u(t);
function g(t, e, n) {
	void 0 === n && (n = 300);
...
function h(e) {
	...
	return function(e) {
		...
		const y = i ? `${a}--${d}` : a, v = i ? `${r}--${d}` : r, T = (0, import_react.useRef)(0);
		...
		}, [h]), import_react.createElement(import_react.Fragment, null, u);
	};
}
function y(t, e) {
	return null != t ? {
...
var v = {
	...
	info: function(e) {
		return import_react.createElement(T, { ...e }, import_react.createElement("path", { d: "M12 0a12 12 0 1012 12A12.013 12.013 0 0012 0zm.25 5a1.5 1.5 0 11-1.5 1.5 1.5 1.5 0 011.5-1.5zm2.25 13.5h-4a1 1 0 010-2h.75a.25.25 0 00.25-.25v-4.5a.25.25 0 00-.25-.25h-.75a1 1 0 010-2h1a2 2 0 012 2v4.75a.25.25 0 00.25.25h.75a1 1 0 110 2z" }));
	},
	warning: function(e) {
		return import_react.createElement(T, { ...e }, import_react.createElement("path", { d: "M23.32 17.191L15.438 2.184C14.728.833 13.416 0 11.996 0c-1.42 0-2.733.833-3.443 2.184L.533 17.448a4.744 4.744 0 000 4.368C1.243 23.167 2.555 24 3.975 24h16.05C22.22 24 24 22.044 24 19.632c0-.904-.251-1.746-.68-2.44zm-9.622 1.46c0 1.033-.724 1.823-1.698 1.823s-1.698-.79-1.698-1.822v-.043c0-1.028.724-1.822 1.698-1.822s1.698.79 1.698 1.822v.043zm.039-12.285l-.84 8.06c-.057.581-.408.943-.897.943-.49 0-.84-.367-.896-.942l-.84-8.065c-.057-.624.25-1.095.779-1.095h1.91c.528.005.84.476.784 1.1z" }));
	},
	success: function(e) {
		return import_react.createElement(T, { ...e }, import_react.createElement("path", { d: "M12 0a12 12 0 1012 12A12.014 12.014 0 0012 0zm6.927 8.2l-6.845 9.289a1.011 1.011 0 01-1.43.188l-4.888-3.908a1 1 0 111.25-1.562l4.076 3.261 6.227-8.451a1 1 0 111.61 1.183z" }));
	},
	error: function(e) {
		return import_react.createElement(T, { ...e }, import_react.createElement("path", { d: "M11.983 0a12.206 12.206 0 00-8.51 3.653A11.8 11.8 0 000 12.207 11.779 11.779 0 0011.8 24h.214A12.111 12.111 0 0024 11.791 11.766 11.766 0 0011.983 0zM10.5 16.542a1.476 1.476 0 011.449-1.53h.027a1.527 1.527 0 011.523 1.47 1.475 1.475 0 01-1.449 1.53h-.027a1.529 1.529 0 01-1.523-1.47zM11 12.5v-6a1 1 0 012 0v6a1 1 0 11-2 0z" }));
	},
	spinner: function() {
...
function C(t) {
	const [, o] = (0, import_react.useReducer)((t) => t + 1, 0), [l, c] = (0, import_react.useState)([]), g = (0, import_react.useRef)(null), h = (0, import_react.useRef)(/* @__PURE__ */ new Map()).current, T = (t) => -1 !== l.indexOf(t), C = (0, import_react.useRef)({
		toastKey: 1,
		displayedToast: 0,
		count: 0,
		queue: [],
	...
	function L(t, n) {
		...
		M.iconOut = function(t) {
			...
			return !1 === r || (p(r) ? i = r(l) : (0, import_react.isValidElement)(r) ? i = (0, import_react.cloneElement)(r, l) : d(r) || u(r) ? i = r : s ? i = E.spinner() : ((t) => t in E)(o) && (i = E[o](l))), i;
		...
		let x = t;
		(0, import_react.isValidElement)(t) && !d(t.type) ? x = (0, import_react.cloneElement)(t, {
			closeToast: L,
			toastProps: M,
			data: T
		}) : p(t) && (x = t({
	...
	return (0, import_react.useEffect)(() => (C.containerId = t.containerId, v.cancelEmit(3).on(0, L).on(1, (t) => g.current && I(t)).on(5, b).emit(2, C), () => {
		h.clear(), v.emit(3, C);
	}), []), (0, import_react.useEffect)(() => {
		C.props = t, C.isToastActive = T, C.displayedToast = l.length;
	}), {
		getToastToRender: function(e) {
			const n = /* @__PURE__ */ new Map(), o = Array.from(h.values());
...
function _(t) {
	const [o, a] = (0, import_react.useState)(!1), [r, l] = (0, import_react.useState)(!1), c = (0, import_react.useRef)(null), u = (0, import_react.useRef)({
		start: 0,
		x: 0,
		y: 0,
		delta: 0,
		...
		boundingRect: null,
		didMove: !1
	}).current, d = (0, import_react.useRef)(t), { autoClose: m, pauseOnHover: f, closeToast: g, onClick: h, closeOnClick: y } = t;
	function v(e) {
		if (t.draggable) {
	...
	(0, import_react.useEffect)(() => {
		d.current = t;
	}), (0, import_react.useEffect)(() => (c.current && c.current.addEventListener("d", E, { once: !0 }), p(t.onOpen) && t.onOpen((0, import_react.isValidElement)(t.children) && t.children.props), () => {
		const t = d.current;
		p(t.onClose) && t.onClose((0, import_react.isValidElement)(t.children) && t.children.props);
	}), []), (0, import_react.useEffect)(() => (t.pauseOnFocusLoss && (document.hasFocus() || C(), window.addEventListener("focus", E), window.addEventListener("blur", C)), () => {
...
function O(e) {
	...
	const v = clsx("Toastify__progress-bar", u ? "Toastify__progress-bar--controlled" : "Toastify__progress-bar--animated", `Toastify__progress-bar-theme--${g}`, `Toastify__progress-bar--${a}`, { "Toastify__progress-bar--rtl": m }), T = p(i) ? i({
		rtl: m,
		type: a,
		defaultClassName: v
	}) : clsx(v, i);
...
var N = (n) => {
	...
	let Q = null;
	return !1 === l || (Q = p(l) ? l(q) : (0, import_react.isValidElement)(l) ? (0, import_react.cloneElement)(l, q) : L(q)), import_react.createElement(y, {
		isIn: P,
		done: k,
		position: v,
		...
		...P && { role: R },
		className: p(C) ? C({ type: f }) : clsx("Toastify__toast-body", C),
		style: b
	}, null != D && import_react.createElement("div", { className: clsx("Toastify__toast-icon", { "Toastify--animate-icon Toastify__zoom-enter": !B }) }, D), import_react.createElement("div", null, u)), Q, import_react.createElement(O, {
		...M && !S ? { key: `pb-${M}` } : {},
		rtl: x,
		theme: z,
		delay: d,
...
}, R = h(M("bounce", !0)), w = h(M("slide", !0)), x = h(M("zoom")), $ = h(M("flip")), k = (0, import_react.forwardRef)((e, n) => {
	const { getToastToRender: o, containerRef: a, isToastActive: r } = C(e), { className: i, style: l, rtl: u, containerId: d } = e;
	function f(t) {
		const e = clsx("Toastify__toast-container", `Toastify__toast-container--${t}`, { "Toastify__toast-container--rtl": u });
		return p(i) ? i({
			position: t,
			rtl: u,
			defaultClassName: e
...
var P, B = /* @__PURE__ */ new Map(), D = [], A = 1;
function z() {
	return "" + A++;
}
function F(t) {
...
//#endregion
export { R as Bounce, $ as Flip, E as Icons, w as Slide, k as ToastContainer, x as Zoom, g as collapseToast, h as cssTransition, Q as toast, _ as useToast, C as useToastContainer };
